...
public class TabWidget extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //added man.tang 20121106 add connection
        intent = new Intent().setClass(this, Connection.class);
        spec = tabHost.newTabSpec("connection").setIndicator("", res.getDrawable(R.drawable.ic_tab_host)).setContent(intent);
        tabHost.addTab(spec);
